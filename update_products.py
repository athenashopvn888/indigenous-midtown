"""
Indigenous Midtown Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the indigenous-midtown folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  Indigenous Midtown Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://indigenousmidtowncannabis.ca")
    else:
