...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Indigenous Midtown Cannabis Price And Flower Tier Guide for Adults 19+",
    seoTitle: "Indigenous Midtown Cannabis Price Tier Guide | Adult 19+",
    seo_title: "Indigenous Midtown Cannabis Price Tier Guide | Adult 19+",
    metaDescription: "Adult 19+ guide to Indigenous Midtown Cannabis flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    meta_description: "Adult 19+ guide to Indigenous Midtown Cannabis flower tiers, weight choices, unit value, and store visit planning in Toronto.",
    h1: "Indigenous Midtown Cannabis Price And Flower Tier Guide for Adults 19+",
    excerpt: "A simple adult 19+ guide to Indigenous Midtown Cannabis flower tiers, weights, and unit value.",
    author: "The Indigenous Midtown Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Indigenous Midtown Cannabis Price And Flower Tier Guide for Adults 19+

Indigenous Midtown Cannabis keeps flower browsing simple for adults 19+ by organizing options into clear price and quality tiers. Instead of guessing where to start, shoppers can pick the grade they want first, then choose the weight that fits the visit and budget.

This guide explains how the tier ladder works, how unit value improves as the weight goes up, and how to use the live menu and store page before visiting in Midtown Toronto.
...
For the smoothest visit, open the Indigenous Midtown Cannabis menu before heading out. The live menu is the best place to compare current categories, weights, and store-specific options. The store page is also useful for directions, contact details, and quick visit planning.
...
- Browse the Indigenous Midtown Cannabis store page for directions, contact details, and visit planning.
...
This guide is for adults 19+ who want a simple way to understand Indigenous Midtown Cannabis flower tiers before visiting.`,
    faq: "",
    internal_links_used: "[Indigenous Midtown Cannabis store page](/weed-dispensary-toronto)\\n[Indigenous Midtown Cannabis homepage](/)\\n[More Indigenous Midtown Cannabis guides](/blog)",
    relatedLinks: [
      {
      ...
      {
        title: "Indigenous Midtown Cannabis homepage",
        url: "https://indigenousmidtowncannabis.com/",
        description: "Store-scoped homepage navigation for adults 19+."
      },
      {
        title: "More Indigenous Midtown Cannabis guides",
        url: "https://indigenousmidtowncannabis.com/blog",
