...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Indigenous Midtown Cannabis is Toronto's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=IMC01`)
      .then((r) => r.json())
    ...
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          ...
          alt="Indigenous Midtown Cannabis Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Indigenous Midtown Cannabis <span className={styles.heroAccent}>Blog</span>
          </h1>
