...
export async function fetchLiveProducts(): Promise<{
  ...
  try {
    const res = await fetch(`${APPS_SCRIPT_URL}?store=IMC01`, {
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at Indigenous Midtown Cannabis, Toronto. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Indigenous Midtown Cannabis carries a curated selection of vape pens and cartridges in Toronto. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 93 Broadway Ave for the best vape selection in ByWard Market.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Indigenous Midtown Cannabis, Toronto. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Indigenous Midtown Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 93 Broadway Ave, Toronto.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Indigenous Midtown Cannabis, Toronto. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Indigenous Midtown Cannabis in Toronto. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 93 Broadway Ave — open daily 24 hours.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Indigenous Midtown Cannabis, Toronto. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Indigenous Midtown Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 93 Broadway Ave, Toronto.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Toronto — Discount Tobacco at Indigenous Midtown Cannabis",
    seoIntro: "Discount native cigarettes at Indigenous Midtown Cannabis, Toronto. Premium and value brands at the best prices on Toronto St.",
    seoDescription: "Indigenous Midtown Cannabis is your go-to source for affordable native cigarettes in Toronto. We carry a wide selection of premium and value tobacco brands at competitive prices. Located at 93 Broadway Ave in the heart of ByWard Market, we're open daily 24 hours. Stop by for the best cigarette prices in the neighbourhood.",
    faqs: [
      { q: "Do you sell cigarettes at Indigenous Midtown Cannabis?", a: "Yes! We carry a wide selection of native cigarette brands at competitive prices." },
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Indigenous Midtown Cannabis, Toronto.",
    seoDescription: "Indigenous Midtown Cannabis carries a curated selection of magic mushrooms and specialty products in Toronto. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 93 Broadway Ave for our full selection.",
    faqs: [
