...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Nicotine Vapes Toronto",
    seoIntro: "Indigenous Midtown Cannabis keeps nicotine vape products separate from THC Vape products so shoppers can clearly distinguish the two categories. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    seoDescription: "Indigenous Midtown Cannabis keeps nicotine vape products separate from THC Vape products so shoppers can clearly distinguish the two categories. Nicotine products are for adults 19+ and contain nicotine, which is addictive.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | Indigenous Midtown Cannabis",
    seoIntro: "Browse specialty items only where they are listed on the current Indigenous Midtown Cannabis menu.",
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Toronto | Indigenous Midtown Cannabis",
    seoIntro: "Native smokes at Indigenous Midtown Cannabis in Toronto. The cigarette menu may show $25 carton-style listings and brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, and Canadian Classics Silver.",
    seoDescription: "Use the cigarette category to compare current Native smoke listings at Indigenous Midtown Cannabis. Specific brands, carton options, and prices can change, so check the current menu or ask staff before visiting.",
    faqs: [
