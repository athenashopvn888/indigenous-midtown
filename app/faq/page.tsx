...
export const metadata: Metadata = {
  title: "FAQ — Indigenous Midtown Cannabis | Toronto Dispensary Questions",
  description:
    "Frequently asked questions about Indigenous Midtown Cannabis in Toronto. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
    canonical: "https://indigenousmidtowncannabis.ca/faq",
  },
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is Indigenous Midtown Cannabis located?", a: "We are located at 93 Broadway Ave, Toronto, ON M4S 2A2. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to Indigenous Midtown Cannabis?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at indigenousmidtowncannabis.ca updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! Indigenous Midtown Cannabis is walk-in only. Just show up anytime — we're open Open 24 Hours." },
      { q: "Can I order online?", a: "Currently, Indigenous Midtown Cannabis is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="Indigenous Midtown Cannabis FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about Indigenous Midtown Cannabis — Toronto&apos;s premium dispensary at 93 Broadway Ave in Toronto.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(437) 870-3710</strong> or visit us at 93 Broadway Ave, Toronto.
            </p>
          </div>
        </div>
        <Footer />
