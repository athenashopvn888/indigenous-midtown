...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    "seoTitle": "Indigenous Midtown Cannabis Resources | Menu and Shopping Guides",
    "description": "Resource guides for shopping the Indigenous Midtown Cannabis menu in Toronto, including flower, value, pre-rolls, and Native smokes where listed.",
    "eyebrow": "Resource Centre",
    "intro": "Welcome to the Indigenous Midtown Cannabis resource centre. This is the no-stress corner for shoppers who want the menu to make sense before they visit. Pick the product lane, compare what matters, then use the current menu or staff for details that change.",
    "cards": [
      {
        "title": "Menu Guide",
    ...
    "sections": [
      ...
      {
        "heading": "Local Notes For Midtown Toronto / Yonge and Eglinton / Mount Pleasant",
        "body": "Indigenous Midtown Cannabis serves shoppers around Midtown Toronto / Yonge and Eglinton / Mount Pleasant, Midtown Toronto, Yonge and Eglinton, Mount Pleasant. If you searched for a weed dispensary in Midtown Toronto / Yonge and Eglinton / Mount Pleasant, this resource section keeps the visit simple: right store, right menu lane, right next step."
      }
    ]
  },
  {
    ...
    "seoTitle": "Indigenous Midtown Cannabis Menu Guide | Toronto Weed Dispensary Tips",
    "description": "How to shop the Indigenous Midtown Cannabis menu by category, with natural tips for flower, pre-rolls, edibles, THC vapes, concentrates, and value shopping.",
    "eyebrow": "Menu Guide",
  ...
  },
  {
    ...
    "seoTitle": "Indigenous Midtown Cannabis Flower Guide | Exotic, Premium, Budget",
    "description": "Compare exotic flower, premium flower, budget weed, cheap weed, and affordable weed at Indigenous Midtown Cannabis without guessing.",
  ...
  },
  {
    ...
    "seoTitle": "Indigenous Midtown Cannabis Value Guide | Cheap Weed and Budget Weed",
    "description": "A practical value guide for shoppers comparing cheap weed, budget weed, affordable weed, and menu categories at Indigenous Midtown Cannabis.",
    "eyebrow": "Value Guide",
  ...
  },
  {
    ...
    "seoTitle": "Indigenous Midtown Cannabis Pre-Roll Guide | Toronto Cannabis Menu Tips",
    "description": "How to compare pre-rolls at Indigenous Midtown Cannabis without mixing them up with flower, edibles, THC vapes, and concentrates.",
  ...
  },
  {
    ...
    "description": "The Indigenous Midtown Cannabis resource centre gives shoppers cleaner menu guides for flower, value, pre-rolls, and store visits.",
  ...
  },
  {
    ...
    "description": "Indigenous Midtown Cannabis Native smokes resource with cigarette brand names shown on the menu and $25 carton notes where listed.",
    "eyebrow": "Native Smokes",
    "intro": "Indigenous Midtown Cannabis shoppers looking for Native smokes can use this page as a cleaner starting point. Brand names shown on the cigarette menu include Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, Canadian Classics Silver, * Rolled Gold Lights, Nexus Full, Nexus Lights, and Time Full. Some carton-style listings show around $25, but shoppers should check the current menu or staff before making the trip.",
    "cards": [
      {
  ...
  },
  {
    ...
    "seoTitle": "Indigenous Midtown Cannabis Native Cigarettes Guide | Brands and Carton Notes",
    "description": "A shopper-friendly Native cigarettes guide for Indigenous Midtown Cannabis, including brand names shown on the menu and $25 carton notes where listed.",
