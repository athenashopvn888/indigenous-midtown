...
export const metadata: Metadata = {
  title: { absolute: "Budtender Or Manager Application | Indigenous Midtown Cannabis" },
  description:
    "Apply online for budtender or manager opportunities at Indigenous Midtown Cannabis. Submit availability, customer-service experience, motivation, determination, and a required selfie.",
  alternates: {
    canonical: "https://www.indigenousmidtowncannabis.ca/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Indigenous Midtown.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Indigenous Midtown Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Indigenous Midtown Cannabis is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at Indigenous Midtown</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentGrid}>
          ...
          <section id="application" className={styles.formPanel} aria-label="Budtender application form">
            <div className={styles.formIntro}>
              ...
              <p>
                This form sends your response to the shared Athena Store Applications sheet under IMC01.
              </p>
