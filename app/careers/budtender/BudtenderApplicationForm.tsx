...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at Indigenous Midtown" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="IMC01" />
      <input type="hidden" name="StoreName" value="Indigenous Midtown Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at Indigenous Midtown Cannabis?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Yonge and Eglinton for scheduled shifts?</legend>
