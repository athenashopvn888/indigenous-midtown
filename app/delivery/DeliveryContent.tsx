...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <section className={`${styles.hero} ${styles.heroPlain}`}>
      <div><p>Indigenous Midtown Cannabis</p><h1>Delivery Menu</h1><span>Browse the shared product catalog. The store confirms current availability and delivery details before an order is accepted.</span></div>
    </section>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>93 Broadway Ave, Toronto</strong>. We are <strong>Open 24 Hours</strong>. Call <strong>(437) 870-3710</strong>.</p></div>
