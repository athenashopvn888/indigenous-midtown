      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <div className={styles.brandBlock}>
            <img src="/storeFavicon.webp" alt="Indigenous Midtown Cannabis Icon" style={{ height: "60px", width: "60px", objectFit: "contain", borderRadius: "8px", marginBottom: "8px" }} />
      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            <h2 className={styles.seoPanelTitle}>Broadway Ave & Redpath Ave's Premier Cannabis Dispensary — Open 24 Hours</h2>
            <p className={styles.seoPanelText}>
              Welcome to <strong>Indigenous Midtown Cannabis</strong>, Toronto's premier 24-hour cannabis destination at 93 Broadway Ave. We carry an electrifying selection of top-shelf strains around the clock — from ultra-rare exotics to solid everyday budget picks.
            </p>
            <p className={styles.seoPanelText}>
              Open 24 hours, 7 days a week — Indigenous Midtown Cannabis never closes. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down after a late shift or stocking up for the weekend, our knowledgeable staff can help during listed store hours.
            </p>
            <p className={styles.seoPanelText}>
              Searching for a cannabis dispensary in Toronto or the surrounding area? Indigenous Midtown Cannabis is your 24-hour destination for premium flower, potent prerolls, and artisan edibles. Our six-tier pricing system means quality cannabis at every budget level — starting from just $3/g.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className={styles.storeGrid}>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                ...
                <br />
                <span className={styles.storeHighlight}>Broadway Ave & Redpath Ave, Toronto</span>
              </p>
            </div>
          </div>
