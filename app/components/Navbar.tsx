  ...
  return (
    <nav className={styles.navbar} id="main-nav">
      ...
      <div className={styles.topBar}>
        <Link href="/" className={styles.logo} aria-label="Indigenous Midtown Cannabis" style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none" }}>
          <img src="/storeFavicon.webp" alt="Indigenous Midtown Cannabis Logo" style={{ height: "30px", width: "30px", objectFit: "contain", borderRadius: "4px" }} />
