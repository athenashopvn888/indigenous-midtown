...
test("approved discovery routes are present",()=>{for(const href of ["/resources/weed-flower-guide","/resources/menu-guide","/resources/weed-value-guide","/resources/pre-roll-guide","/resources"])assert.ok(owner.includes(`"${href}"`));assert.doesNotMatch(owner,/available now|in stock|best price/i)});
